...
@Autonomous(name = "RED - FAR: 9 ball", group = "Autonomous")
@Configurable // Panels
public class redFarNineBallAuto extends OpMode {
    ...
    public void init() {
        ...
        launcher.TARGET_RPM = launcher.AUTO_FAR_FAR_TARGET_RPM;
    }
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            toEnd = follower.pathBuilder().addPath(
                            new BezierLine(
                                    new Pose(60, 12).mirror(),

                                    new Pose(48.000, 24.000).mirror()
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(66), Math.toRadians(0))
